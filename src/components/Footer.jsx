...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white py-8 transition-colors duration-300">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-xl font-bold">MovieDB</h3>
        ...
        <div className="mt-8 text-center text-gray-600 dark:text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} MovieDB. All rights reserved.</p>
          <p className="mt-2">
